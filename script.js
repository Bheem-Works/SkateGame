...
ctx.lineWidth = 15;
ctx.fillStyle = "black";
ctx.rect(200,80,1000,900);
ctx.fill();

// Stroke
ctx.lineWidth= 8;
ctx.strokeStyle = "white";
ctx.moveTo(100,140); // First param is used to move left , right and another is used to move to the up and down; 
ctx.lineTo(200,140); // Firs param is used to increase the line size and another is used and second param is used to set the directions;
...
ctx.strokeStyle = "red";
ctx.lineWidth = 30;
ctx.arc(500,750,15,0,Math.PI * 2,false);
ctx.stroke();
